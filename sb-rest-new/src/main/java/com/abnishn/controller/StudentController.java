...
import com.abnishn.service.StudentService;
import com.abnishn.model.Course;
...
public class StudentController {
	...
	public ResponseEntity<Void> registerStudentforCourse(@PathVariable String studentId, @RequestBody Course newCourse){
		...
		URI location=ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(course.id()).toUri();
